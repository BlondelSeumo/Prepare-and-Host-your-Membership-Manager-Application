<?php
   ...
   * @copyright 2020
   * @version $Id: stats.class.php, v1.00 2020-04-20 18:20:24 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  class Stats
  {
      ...
      public static function getUserPaymentsChart($id)
      {
          ...
          foreach ($labels as $k => $label) {
              $data['label'][] = $label;
              $data['color'][] = $color[$k];
              $data['legend'][] = '<div class="item"><span class="wojo ring label spaced" style="background:' . $color[$k] . '"> </span> ' . $label . '</div>';
          }
      ...
      public static function getMainStats()
      {
          ...
          if ($memberships) {
              ...
              $data['label'][] = '-/-';
              $data['color'][] = $color[0];
              $data['legend'][] = '<div class="item"><span class="wojo ring label spaced" style="background:' . $color[0] . '"> </span> -/-</div>';
          }
