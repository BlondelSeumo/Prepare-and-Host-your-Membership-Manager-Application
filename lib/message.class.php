<?php
   ...
   * @copyright 2020
   * @version $Id: message.class.php, v1.00 2020-03-20 18:20:24 gewa Exp $
   */
  ...
  class Message
  {
      ...
      {
          self::$showMsg = "<div class=\"wojo icon message alert\"><i class=\"notification sign icon\"></i><i class=\"close icon\"></i>";
      ...
      {
          self::$showMsg = "<div class=\"wojo alert small icon message\"><i class=\"notification sign icon\"></i> <div class=\"content\">" . $msg . "</div></div>";
      ...
      {
          self::$showMsg = "<div class=\"wojo icon message positive\"><i class=\"circle check icon\"></i><i class=\"close icon\"></i>";
      ...
      {
          self::$showMsg = "<div class=\"wojo icon message info\"><i class=\"info sign icon\"></i><i class=\"close icon\"></i>";
      ...
      {
          self::$showMsg = "<div class=\"wojo info small icon message\"><i class=\"info sign icon\"></i> <div class=\"content\">" . $msg . "</div></div>";
      ...
      {
          self::$showMsg = "<div class=\"wojo icon message negative\"><i class=\"circle minus icon\"></i><i class=\"close icon\"></i>";
      ...
      {
          self::$showMsg = "<div class=\"wojo negative icon small message\"><i class=\"circle minus icon\"></i> <div class=\"content\">" . $msg . "</div></div>";
