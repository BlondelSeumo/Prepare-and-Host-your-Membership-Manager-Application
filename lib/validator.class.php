<?php
   ...
   * @copyright 2020
   * @version $Id: validator.class.php, v1.2020 2016-04-20 18:20:24 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  class Validator
  {
      ...
      public static $basic_tags =
          '<br><p><a><strong><b><i><em><img><blockquote><code><dd><dl><hr><h1><h2><h3><h4><h5><h6><label><ul><li><span><sub><sup><u>';

      public static $advanced_tags =
          '<body><html><section><article><video><audio><source><div><table><td><tr><th><tbody><thead><img><svg><figure><br><p><a><strong><u><b><i><em><img><blockquote><code><dd><dl><hr><h1><h2><h3><h4><h5><h6><label><ul><li><span><sub><sup><button><defs><path><clipPath><style><ellipse><circle><g><polyline><line><rect><polygon>';
       ...
       * @return
       */
      public static function alphaBits($all, $vars, $class = "wojo small horizontal compact divided list")
      {
          if (!empty($all)) {
              $parts = explode("/", $all);
