...
<div class="wojo small segment form">
  <form method="post" id="an_form" name="an_form">
      ...
      <div class="field">
        <label>Select One</label>
          ...
          <div class="wojo checkbox radio inline">
            <input type="radio" name="cctype" value="V" id="vs">
            <label for="vs"><img src="<?php echo SITEURL;?>/gateways/anet/vs.png" alt=""></label>
          </div>
          <div class="wojo checkbox radio inline">
            <input type="radio" name="cctype" value="M" id="mc">
            <label for="mc"><img src="<?php echo SITEURL;?>/gateways/anet/mc.png" alt=""></label>
          </div>
          <div class="wojo checkbox radio inline">
            <input type="radio" name="cctype" value="A" id="ae">
            <label for="ae"><img src="<?php echo SITEURL;?>/gateways/anet/ae.png" alt=""></label>
          </div>
          <div class="wojo checkbox radio inline">
            <input type="radio" name="cctype" value="D" id="dc">
            <label for="dc"><img src="<?php echo SITEURL;?>/gateways/anet/dc.png" alt=""></label>
          </div>
    ...
    <div class="center aligned">
      <button class="wojo secondary button" data-action="doAnet" data-url="<?php echo SITEURL;?>/gateways/anet/ipn.php" name="dosubmit" type="button"><?php echo Lang::$word->SUBMITP;?></button>
    </div>
  </form>
</div>
