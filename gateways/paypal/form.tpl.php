...
<input type="image" src="<?php echo SITEURL;?>/gateways/paypal/logo_large.png" style="width:150px" name="submit" class="wojo basic primary button" title="Pay With Paypal" alt="" onclick="document.pp_form.submit();">
