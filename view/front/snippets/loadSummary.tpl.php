...
?>
<table class="wojo segment responsive table">
  <thead>
    <tr>
  ...
  <tr id="gatedata">
    ...
    <td><div class="row grid phone-2 mobile-3 tablet-4 screen-5 small gutters align center">
        ...
        <?php continue;?>
        <?php else:?>
        <div class="columns"> <a class="wojo small fluid button sGateway" data-id="<?php echo $grows->id;?>"><?php echo $grows->displayname;?></a></div>
        <?php endif;?>
        <?php endforeach;?>
      </div></td>
  </tr>
