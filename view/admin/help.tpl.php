<?php
   ...
   * @copyright 2020
   * @version $Id: help.tpl.php, v1.00 2020-03-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
      die('Direct access to this location is not allowed.');
?>
<h2><?php echo Lang::$word->HP_TITLE;?></h2>
<p class="wojo small text"><?php echo Lang::$word->HP_INFO;?></p>
<div class="wojo tabs">
  <ul class="nav">
    <li class="active"><a data-tab="login"><?php echo Lang::$word->HP_SUB1;?></a>
    </li>
    <li><a data-tab="redirect"><?php echo Lang::$word->HP_SUB2;?></a>
    </li>
    <li><a data-tab="form"><?php echo Lang::$word->HP_SUB3;?></a>
    </li>
    <li><a data-tab="membership"><?php echo Lang::$word->HP_SUB4;?></a>
    </li>
    <li><a data-tab="cron"><?php echo Lang::$word->HP_SUB5;?></a>
    </li>
    <li><a data-tab="builder" class="last"><?php echo Lang::$word->HP_SUB6;?></a>
    </li>
  </ul>
  <div class="wojo segment tab">
    <!-- login -->
    <div data-tab="login" class="item">
...
<span style="color: #BC7A00">?&gt;</span> 
    ...
    <!-- redirect -->
    <div data-tab="redirect" class="item">
      <h4>Redirecting user on successful login</h4>
      <p class="wojo small text">By default when user logs in, it will be redirected to profile page. You can change this behavior by redirecting user to any page of your choice. First start by creating a new php page that you want to redirect user on successful login. Let's call this page for the purpose of this tutorial redirect_page.php. Open up <strong>view/front/js/master.js</strong> file and look for:</p>
      <div class="wojo space divider"></div>
      <pre style="margin: 0; line-height: 125%">
<span style="color: #008000; font-weight: bold">window.location.href = config.surl + "/dashboard/";</span>
</pre>
      <div class="wojo space divider"></div>
      <p class="wojo small text">Replace word <strong>dashboard</strong> with your new redirect page, if page is part of framework. or replace <strong> dashboard/</strong> with <strong>redirect_page.php</strong> like  <span style="color: #008000; font-weight: bold">window.location.href = config.surl + "/redirect_page.php";</span>  Now you can continue to add the usual html or php code to your page. If you need to protect this page using valid membership, follow instructions from Help Section. In this example on successful login, we redirected user to our custom page. </p>
    </div>
    
    <!-- form -->
    <div data-tab="form" class="item">
...
<span style="color: #BC7A00">&lt;?php</span> <span style="color: #008000; font-weight: bold">print</span> Message<span style="color: #666666">::</span><span style="color: #19177C">$showMsg</span>;<span style="color: #BC7A00">?&gt;</span>
    ...
    <!-- membership -->
    <div data-tab="membership" class="item">
...
<span style="color: #BC7A00">&lt;?php</span> <span style="color: #008000; font-weight: bold">endif</span>;<span style="color: #BC7A00">?&gt;</span>
    ...
    <!-- builder -->
    <div data-tab="builder" class="wojo form item">
      <form method="post" id="wojo_form" name="wojo_form">
        <div class="wojo fields">
          <div class="field five wide">
            <label><?php echo Lang::$word->HP_PNAME;?>
          ...
          <div class="field five wide">
            ...
            <div class="wojo checkbox radio fitted inline">
              <input name="header" type="radio" value="1" id="header_1" checked="checked">
              <label for="header_1"><?php echo Lang::$word->YES;?></label>
            </div>
            <div class="wojo checkbox radio fitted inline">
              <input name="header" type="radio" value="0" id="header_0">
              <label for="header_0"><?php echo Lang::$word->NO;?></label>
            </div>
          </div>
        </div>
        <div class="wojo fields">
          <div class="field five wide">
            <label><?php echo Lang::$word->ADM_MEMBS;?>
              <i class="icon asterisk"></i></label>
            <div class="row grid screen-3 tablet-2 mobile-2 phone-1">
              <?php echo Utility::loopOptionsMultiple($this->mlist, "id", "title", '', "membership_id", "normal");?>
            </div>
          </div>
          <div class="field five wide">
            <p class="wojo small text"><?php echo Lang::$word->HP_INFO;?></p>
        ...
        <div class="center aligned">
          <button type="button" data-action="pageBuilder" name="dosubmit" class="wojo primary button"><?php echo Lang::$word->HP_PBUILD;?></button>
        </div>
      </form>
    </div>
  </div>
