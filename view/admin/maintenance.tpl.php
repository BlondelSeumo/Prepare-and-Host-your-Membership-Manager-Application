<?php
   ...
   * @copyright 2020
   * @version $Id: maintenance.tpl.php, v1.00 2020-05-05 10:12:05 gewa Exp $
   */
  if (!defined("_WOJO"))
  ...
  <div class="wojo form segment">
    <div class="wojo fields">
      ...
      <div class="field five wide">
        ...
        <button type="button" data-action="processMInactive" name="dosubmit" class="wojo negative button"><?php echo Lang::$word->MT_IUBTN;?></button>
      </div>
    </div>
  ...
  <div class="wojo form segment">
    <div class="wojo fields">
      <div class="field three wide basic">
        ...
        <p><?php echo str_replace("[TOTAL]", '<span class="wojo dark inverted label" id="banned">' . $this->banned . '</span>', Lang::$word->MT_BUSERS_T);?></p>
      </div>
      <div class="field five wide basic">
        <label><?php echo Lang::$word->DELETE;?></label>
        <button type="button" data-action="processMIBanned" name="dosubmit" class="wojo negative button"><?php echo Lang::$word->MT_BUBTN;?></button>
      </div>
    </div>
  </div>
</form>
<form method="post" name="wojo_formc">
  <div class="wojo form segment">
    <div class="wojo fields">
      ...
      <div class="field five wide basic">
        <label><?php echo Lang::$word->DELETE;?></label>
        <button type="button" data-action="processMCart" name="dosubmit" class="wojo negative button"><?php echo Lang::$word->MT_CRBTN;?></button>
      </div>
    </div>
  </div>
</form>